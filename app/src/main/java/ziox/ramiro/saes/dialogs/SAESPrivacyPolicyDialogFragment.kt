...
import ziox.ramiro.saes.databinding.DialogFragmentWebviewBinding

/**
 * Creado por Ramiro el 9/4/2018 a las 9:10 PM para SAES.
 */
class SAESPrivacyPolicyDialogFragment : DialogFragment() {
