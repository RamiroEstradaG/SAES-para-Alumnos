package ziox.ramiro.saes.views.selectablebuttonview
...
import kotlinx.android.synthetic.main.item_selectable_button.view.*
...
class SelectableButtonView : FlexboxLayout{
    ...
    fun setOptions(data: Array<String>){
        ...
        for((i, name) in data.copyOfRange(padStart, data.size - padEnd).withIndex()){
            val optionButton = LayoutInflater.from(context).inflate(R.layout.item_selectable_button, null, true).itemeSelectableButton
